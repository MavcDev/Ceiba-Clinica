...
public class ValidadorArgumento {
    ...
    public static void validarSoloCeros(String valor, String mensaje){
        try {
            ...
            throw excepcionValorInvalido;
        }
    }

    public static void validarTextoBlanco(String valor, String mensaje){
        if(valor.trim().isEmpty() || valor.trim().isBlank()){
            throw new ExcepcionValorInvalido(mensaje);
        }
    }

    public static void validarFechaMayorActual(LocalDate fecha, String mensaje){
        if(fecha.isAfter(LocalDate.now())) {
            throw new ExcepcionValorInvalido(mensaje);
        }
    }

    public static void validarFechaMenorActual(LocalDate fecha, String mensaje){
        if(fecha.isBefore(LocalDate.now())) {
            throw new ExcepcionValorInvalido(mensaje);
        }
    }

    public static void validarFechaEsIgualActual(LocalDate fecha, String mensaje){
